...
public class FolDemo {
	...
	private static void fOL_TFMResolutionDemo() {
		//System.out.println("-------------------------------------");
		//System.out.println("TFM Resolution,filosofosDemo 1");
		//System.out.println("-------------------------------------");
		//filosofosDemo1(new FOLTFMResolution());	
		
		//Ejercicio 1: Alumnos deprimidos 
		/*
		System.out.println("---------------------------------------");
		System.out.println("TFM Resolution, Alumnos Demo");
		System.out.println("---------------------------------");
		alumnosDemo1(new FOLTFMResolution());
		*/
		
		//Ejercicio 2: Madrileños 
		/*
		System.out.println("-------------------------------------");
		System.out.println("TFM Resolution, madrilenosDemo 1");
	    System.out.println("-------------------------------------");
		madrilenosDemo1(new FOLTFMResolution());
		*/

		//Ejercicio 3: todos los hombres son mortales
		
		System.out.println("-------------------------------------");
		System.out.println("TFM Resolution, personaDemo1");
		System.out.println("-------------------------------------");
		personaDemo1(new FOLTFMResolution());
		
		
		// Ejercicio 4: Loves animal, quien mato al gato?
		/*
		System.out.println("-------------------------------------");
		...
		*/
		...
		// Ejercicio 5: Porteñas alegres
		/*
		System.out.println("---------------------------------------");
		System.out.println("TFM Resolution, PortenasAlegres Demo");
		System.out.println("---------------------------------------");
		portenasAlegresDemo1(new FOLTFMResolution());
		*/
		
		// Ejercicio 6: Protozoos
		
		//System.out.println("---------------------------------------"); 
    	//System.out.println("TFM Resolution, Protozoos Demo 1");
		//System.out.println("-------------------------------------");
		//protozoosDemo1(new FOLTFMResolution());
		
		
		// Ejercicio 7: Psicologos
		/*
		System.out.println("-------------------------------------");
		System.out.println("TFM Resolution, psicologosDemo 1");
		System.out.println("-------------------------------------");
		psicologosDemo1(new FOLTFMResolution());
		*/
		
		// Ejercicio 7: Psicologos
		/*
		System.out.println("-------------------------------------");
		System.out.println("TFM Resolution, PajaroEsquiador Demo 1");
		System.out.println("-------------------------------------");
		pajaroEsquiadorDemo1(new FOLTFMResolution());
		*/
		
		// Ejercicio 8: Psicologos
		/*
		System.out.println("---------------------------------------");
		System.out.println("TFM Resolution, AnimalesDeLaSelva Demo 1");
		System.out.println("---------------------------------------");
		animalesDeLaSelvaDemo1(new FOLTFMResolution());
		*/
	...
	private static void personaDemo1(InferenceProcedure ip) {
		StandardizeApartIndexicalFactory.flush();

		FOLKnowledgeBase kb = FOLKnowledgeBaseFactory
				.createPersonaKnowledgeBase(ip);

		String kbStr = kb.toString();


		String query = "Mortal(Socrates)"; 
		//String query = "FORALL x Mortal(x)"; // No puede contestar
		//String query = "FORALL x (Persona(x) => Mortal(x))"; // No puede contestar
		
		
		InferenceResult answer = kb.ask(query);

		System.out.println("Persona Knowledge Base:");
	...
	// Ejercicio 1: Alumnos
	private static void alumnosDemo1(InferenceProcedure ip) {
		StandardizeApartIndexicalFactory.flush();

		FOLKnowledgeBase kb = FOLKnowledgeBaseFactory
				.createAlumnosKnowledgeBase(ip);

		String kbStr = kb.toString();

        String query = "EXISTS x (Alumno(x) AND Deprimido(x))";
        //String query = "EXISTS x (Alumno(x) AND NOT Deprimido(x))";
     	
        InferenceResult answer = kb.ask(query);

		System.out.println("\nAlumnos Knowledge Base:");
		System.out.println(kbStr);
		System.out.println("Query: " + query);
		for (Proof p : answer.getProofs()) {
			System.out.print(ProofPrinter.printProof(p));
	...
	// Ejercicio 2: Madrileños
	private static void madrilenosDemo1(InferenceProcedure ip) {
		StandardizeApartIndexicalFactory.flush();

		FOLKnowledgeBase kb = FOLKnowledgeBaseFactory
				.createMadrilenosKnowledgeBase(ip);

		String kbStr = kb.toString();

        String query = "EXISTS x (Asocial(x))"; 
        
		InferenceResult answer = kb.ask(query);

		System.out.println("\nMadrilenos Knowledge Base:");
		System.out.println(kbStr);
		System.out.println("Query: " + query);
		for (Proof p : answer.getProofs()) {
			System.out.print(ProofPrinter.printProof(p));
	...
	private static void portenasAlegresDemo1(InferenceProcedure ip) {
		StandardizeApartIndexicalFactory.flush();

		FOLKnowledgeBase kb = FOLKnowledgeBaseFactory
				.createPortenasAlegresKnowledgeBase(ip);
		...
		Predicate query = new Predicate("Porteno", terms);
        */
		String query = "EXISTS x (Cornudo(x) AND Feliz(x))";
		//String query = "EXISTS x (Porteno(x))";
		//String query = "EXISTS x (Porteno(x) AND Feliz(x))";
		
		InferenceResult answer = kb.ask(query);

		System.out.println("Portenas Alegres Knowledge Base:");
		System.out.println(kbStr);
		System.out.println("Query: " + query);
		for (Proof p : answer.getProofs()) {
			System.out.print(ProofPrinter.printProof(p));
	...
	private static void portenasAlegresDemo10(InferenceProcedure ip) {
		StandardizeApartIndexicalFactory.flush();
		...
		List<Term> terms = new ArrayList<Term>();
		terms.add(new Variable("X"));
		Predicate query = new Predicate("Cornudo", terms);
		//Predicate query = new Predicate("TienePico", terms);
        //String query = "EXISTS x Cornudo(x)"; 
		InferenceResult answer = kb.ask(query);

		System.out.println("ProtenasAlegres Knowledge Base:");
		System.out.println(kbStr);
		System.out.println("Query: " + query);
		for (Proof p : answer.getProofs()) {
			System.out.print(ProofPrinter.printProof(p));
	...
	private static void protozoosDemo1(InferenceProcedure ip) {
		StandardizeApartIndexicalFactory.flush();

		FOLKnowledgeBase kb = FOLKnowledgeBaseFactory
				.createProtozoosKnowledgeBase(ip);

		String kbStr = kb.toString();

        String query = "EXISTS x EXISTS y (Naturalista(x) AND Protozoo(y) AND Peludo(y) AND Observa(x,y))"; 
		InferenceResult answer = kb.ask(query);

		System.out.println("\nProtozoos Knowledge Base:");
		System.out.println(kbStr);
		System.out.println("Query: " + query);
		for (Proof p : answer.getProofs()) {
			System.out.print(ProofPrinter.printProof(p));
	...
	private static void psicologosDemo1(InferenceProcedure ip) {
		StandardizeApartIndexicalFactory.flush();

		FOLKnowledgeBase kb = FOLKnowledgeBaseFactory
				.createPsicologosKnowledgeBase(ip);

		String kbStr = kb.toString();

        String query = "NOT EXISTS x (EstudiosoConducta(x) AND PersonaInsegura(x))";
       
        
		InferenceResult answer = kb.ask(query);

		System.out.println("\nPsicologos Knowledge Base:");
		System.out.println(kbStr);
		System.out.println("Query: " + query);
		for (Proof p : answer.getProofs()) {
			System.out.print(ProofPrinter.printProof(p));
	...
	private static void filosofosDemo1(InferenceProcedure ip) {
		StandardizeApartIndexicalFactory.flush();

		FOLKnowledgeBase kb = FOLKnowledgeBaseFactory
				.createFilosofosKnowledgeBase(ip);
	...
	private static void animalesDeLaSelvaDemo1(InferenceProcedure ip) {
		StandardizeApartIndexicalFactory.flush();

		FOLKnowledgeBase kb = FOLKnowledgeBaseFactory
				.createAnimalesDeLaSelvaKnowledgeBase(ip);
		...
		//terms.add(new Variable("X"));
		//terms.add(new Variable("Y"));
		//Predicate query = new Predicate("Solucion", terms);
        String query ="(NOT (Animal(x) AND Selva(x) AND FORALL w Teme(w,x)))";
		InferenceResult answer = kb.ask(query);

		System.out.println("AnimalesDeLaSelva Knowledge Base:");
		System.out.println(kbStr);
		System.out.println("Query: " + query);
		for (Proof p : answer.getProofs()) {
			System.out.print(ProofPrinter.printProof(p));
	...
	private static void pajaroEsquiadorDemo1(InferenceProcedure ip) {
		StandardizeApartIndexicalFactory.flush();

		FOLKnowledgeBase kb = FOLKnowledgeBaseFactory
				.createPajaroEsquiadorKnowledgeBase(ip);
		...
		//Predicate query = new Predicate("Solucion", terms);
		//Predicate query = new Predicate("TienePico", terms);
        String query = "EXISTS x (PajaroEsquiador(x) AND Vuela(x))"; 
		InferenceResult answer = kb.ask(query);

		System.out.println("PajaroEsquiador Knowledge Base:");
		System.out.println(kbStr);
		System.out.println("Query: " + query);
		for (Proof p : answer.getProofs()) {
			System.out.print(ProofPrinter.printProof(p));
	...
	private static void lovesAnimalDemo(InferenceProcedure ip) {
		...
		String query = "Kills(Curiosity,Tuna)";
